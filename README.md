...
Link to each project's section on this page: 
||||||| 
| ----------- | ----------- | ----------- | ----------- | ----------- |----------- |
|[PantryPal](#pantrypal)| [OCR](#ocr) | [Classification](#classification)| [Regression](#regression) | [Score Calculator](#score-calculator) | [TicTacToe App](#tictactoe) |
...
<p float="left">
  ...
  <img src="Screenshots/gen.png" alt="screenshot taking a picture" style="width:250px;"> 
 </p>
...
<p float="left">
  <img src="Screenshots/Snapshots/top1.png" alt="top level" style="width:325px;">
  <img src="Screenshots/Snapshots/top2.png" alt="top level" style="width:325px;">
  <img src="Screenshots/Snapshots/top1e.png" alt="top level" style="width:325px;">
  <img src="Screenshots/Snapshots/top2e.png" alt="top level" style="width:325px;"> 
  <img src="Screenshots/Snapshots/top3e.png" alt="top level" style="width:325px;"> 

  <img src="Screenshots/Snapshots/post.png" alt="top level" style="width:325px;"> 
 </p> 
