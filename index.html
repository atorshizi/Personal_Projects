    ...
    <main>
        <div class="vertical-menu">
            ...
            <details>
                ...
                <br> 
                <a href="https://github.com/atorshizi/Personal_Projects/tree/79628b268bd6d09c629dfae177248366346acb40/PantryPal/src">Source Code</a> 
                </p> 
            </details> 
            ...
            <p>In this project, I created an android app that can recognize text in images from either existing images or from new images that can be taken from the camera directly from the app - this is a form of Optical Character Recognition (OCR). Further, it can also scan one or multiple barcode/QR codes from a single picture and display the raw data and format type - it supports 13 different barcode/QR code formats. It accomplishes these tasks by incorporating the Google ML Kit SDK. 
              ...
              <p>
                ...
                <br> 
                <a href="https://github.com/atorshizi/Personal_Projects/blob/main/OCR/app/src/main/java/com/example/ocr/MainActivity.java">MainActivity.java</a> 
                <br> 
                <a href="https://github.com/atorshizi/Personal_Projects/blob/main/OCR/app/src/main/res/layout/activity_main.xml">MainActivity.xml</a> 
                <br> 
                <a href="https://github.com/atorshizi/Personal_Projects/blob/main/OCR/app/OCR.apk">apk file</a> 
              </p> 
            </details>
            ...
            <details>
              ...
              <p>The main code can be found at the below link: 
                <br> 
                <a href="https://github.com/atorshizi/Personal_Projects/blob/main/Classification">Source Code</a> 
              </p> 
          </details> 
          ...
          <details>
              ...
              <p>The main code can be found at the below link: 
                <br> 
                <a href="https://github.com/atorshizi/Personal_Projects/blob/main/Regression">Source Code</a> 
              </p> 
            </details> 
            ...
            <p>The main code can be found at the below link: 
              <br> 
              <a href="https://github.com/atorshizi/Personal_Projects/blob/main/Score%20Finder">Source Code</a> 
            </p> 
          </details> 
          ...
          <details>
            ...
            <p>The main code and apk can be found at the below links: 
              <br> 
              <a href="https://github.com/atorshizi/Personal_Projects/blob/main/TicTacToe/app/src/main/java/com/example/TicTacToe/MainActivity.java">MainActivity.java</a> 
              <br> 
              <a href="https://github.com/atorshizi/Personal_Projects/blob/main/TicTacToe/app/src/main/res/layout/activity_main.xml">MainActivity.xml</a> 
              <br> 
              <a href="https://github.com/atorshizi/Personal_Projects/blob/main/TicTacToe/app/TicTacToe.apk">apk file</a> 
            </p> 
          </details> 
        </div>
    </main>
