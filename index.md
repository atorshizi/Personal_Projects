A brief description of each of the 3 projects can be found below as well as links to the code and screenshots: [OCR](#ocr), [Score Calculator](#bowling-score-calculator), [TicTacToe](#tictactoe)
